<?php
    ...
    if ($islem == "sil") {
        $id = $_GET["id"];
        $sorgu = $baglan->query("delete from tour_6 where (id='$id')");
        echo "<script> window.location.href='tour_6.php'; </script>";
    }
    ...
    if ($islem == "ekle") {
        ...
        $text = $_POST["text"];
        $sorgu = $baglan->query("insert into tour_6 (name,image,text) values ('$name','../$image','$text')");
        echo "<script> window.location.href='tour_6.php'; </script>";
    }
?>
<!DOCTYPE html>
    ...
    <div style="text-align:center;">
        ...
        while ($satir = $sorgu->fetch_object()) {
            ...
            echo "<tr>
                    ...
                    <td>$satir->image</td>
                    <td>$satir->text</td>
                    <td><a href='tour_6.php?islem=sil&id=$satir->id'>DELETE</td>
                </tr>";}
        ?>
        </table><br>
        <form action="tour_6.php?islem=ekle" enctype="multipart/form-data" method="post">
