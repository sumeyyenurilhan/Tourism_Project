...
error_reporting(E_ALL);
    ...
    if ($islem == "sil") {
        $id = $_GET["id"];
        $sorgu = $baglan->query("delete from homepage_slider where (id='$id')");
        echo "<script> window.location.href='homepage_slider.php'; </script>";
    }
    ...
    if ($islem == "ekle") {
        ...
        $sorgu = $baglan->query("insert into homepage_slider (baslik,resim) values ('$baslik','../$resim')");
        echo "<script> window.location.href='homepage_slider.php'; </script>";
    }
?>
<!doctype html>
...
<head>
    <meta charset="utf-8">
    <title>Admin Panel Home Slider</title>
    <style>
   @import url('https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;500;600&display=swap');
    ...
    <body>
        ...
        <br><hr><br>
        <div style="text-align:center;">
            <a href="homepage_tours.php">Travels Diary</a><a href="homepage_slider.php" class="active">Travels Links</a>
        </div>
    ...
    <table>
        ...
        while ($satir = $sorgu->fetch_object()) {
            ...
            echo "<tr>
                ...
                <td>$satir->baslik</td>
                <td>$satir->resim</td>
                <td><a href='homepage_slider.php?islem=sil&id=$satir->id' class='a'>DELETE</td>
                </tr>";
        }
        ?>
        </table><br>
        <form action="homepage_slider.php?islem=ekle" enctype="multipart/form-data" method="post">
