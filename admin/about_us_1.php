<?php
    ...
    if ($_POST) {
        ...
        $sorgu = $baglan->query("delete from about_us_1");
        $sorgu = $baglan->query("insert into about_us_1 (aciklama) values ('$aciklama')");
        echo "<script> window.location.href='about_us_1.php'; </script>";
    }

    $sorgu = $baglan->query("select * from about_us_1");
...
<html>
    ...
    <div style="text-align:center;">
        ...
        <br><hr><br>
        <div style="text-align:center;">
            <a href="about_us_1.php" class="active">Our Vision and Mission</a><a href="about_us_2.php">Travel Guide</a><a href="about_us_3.php">Requirements</a>
        </div>
